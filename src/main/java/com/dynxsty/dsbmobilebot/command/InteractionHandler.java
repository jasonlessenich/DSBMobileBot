package com.dynxsty.dsbmobilebot.command;

import com.dynxsty.dsbmobilebot.Bot;
import com.dynxsty.dsbmobilebot.command.data.CommandDataLoader;
import com.dynxsty.dsbmobilebot.command.data.context_commands.ContextCommandConfig;
import com.dynxsty.dsbmobilebot.command.data.slash_commands.SlashCommandConfig;
import com.dynxsty.dsbmobilebot.command.data.slash_commands.SlashCommandPrivilegeConfig;
import com.dynxsty.dsbmobilebot.command.interfaces.IMessageContextCommand;
import com.dynxsty.dsbmobilebot.command.interfaces.ISlashCommand;
import com.dynxsty.dsbmobilebot.command.interfaces.IUserContextCommand;
...
public class InteractionHandler extends ListenerAdapter {
	...
	public void registerCommands(Guild guild) {
		SlashCommandConfig[] slashCommandConfigs = CommandDataLoader.loadSlashCommandConfig("commands/slash/commands.yaml");
	...
	private CommandListUpdateAction updateCommands(SlashCommandConfig[] slashCommandConfigs, ContextCommandConfig[] contextConfigs, Guild guild) {
		log.info("[{}] Registering commands", guild.getName());
